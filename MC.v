...
Lemma MCP_congruent_weighted_to : forall n {C C'}, Congruent_weighted n C C' -> Congruent C C'.
Proof.
intros.
...
+ clear n n'; intros n Hn n' Hn'; intros.
  ...
  1: apply Precongr_step_wf_ctx with C; auto; apply MCP_asym_to_step; auto.
