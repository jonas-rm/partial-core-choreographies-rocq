...
Theorem Behaviour_ind_b :
  forall P : Behaviour -> Prop,
    ...
    (forall (p : Pid) (o : Label -> option Behaviour),
      (forall (l:Label), option_apply_or_True P (o l)) ->
      P (p & o)%SP
    ) ->
...
induction B1 using Behaviour_ind_b; induction B2 using Behaviour_ind_b; intros; try inversion H; try easy.
+ simpl.
